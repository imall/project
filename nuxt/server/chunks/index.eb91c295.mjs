...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  const _component_Todo = __nuxt_component_1;
  _push(`<div${ssrRenderAttrs(_attrs)}><h1>\u9996\u9801</h1>`);
  _push(ssrRenderComponent(_component_Card, null, null, _parent));
  _push(ssrRenderComponent(_component_Todo, null, null, _parent));
  _push(`</div>`);
}
...
//# sourceMappingURL=index.eb91c295.mjs.map
